...
- Partage : quatre boutons (X, Reddit, Instagram, lien), avec icône et bordure, flottent en orbite lente autour des questions, reliés à la sphère par un fil de lumière ; au survol, ils s'immobilisent. Après la dernière question, ils quittent l'orbite, se rangent au centre dans un cadre « Partage ta question » et grandissent : c'est l'écran final. Des flèches y font défiler les cinq questions, et une rangée de pastilles choisit le fond de la carte (la sphère d'étoiles, ou une scène du film photographiée sans texte : la mer, la fleur, l'ADN, l'atome, la galaxie, les neurones, le circuit). Instagram ouvre une carte générée à la volée (post 4:5, story 9:16 ou paysage 1,91:1), à partager directement depuis un téléphone ou à télécharger
